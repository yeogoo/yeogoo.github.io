...
const config = {
  ...
  organizationName: 'yeogoo', // Usually your GitHub org/user name.
  projectName: 'yeogoo.github.io', // Usually your repo name.
  trailingSlash: false,
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/yeogoo/yeogoo.github.io',
            label: 'GitHub',
            position: 'right',
          },
        ],
